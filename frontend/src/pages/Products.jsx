...
const Products = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="max-w-2xl">
                            <span className="inline-block px-4 py-1 rounded-full bg-primary-600/20 text-primary-400 text-xs font-bold uppercase tracking-[0.3em] mb-6 backdrop-blur-sm border border-primary-500/30">
                                Est. 2024 • The Marketplace
                            </span>
                            <h1 className="text-6xl md:text-7xl font-black text-white mb-6 leading-tight font-serif italic">
                                Freshness <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-green-300">
                                    Reimagined.
                                </span>
                            </h1>
                            <p className="text-xl text-gray-200 font-medium leading-relaxed mb-10 max-w-lg italic">
                        ...
                        <div className="flex justify-center lg:justify-end">
                            <form onSubmit={handleSearch} className="relative w-full max-w-lg group">
                                <div className="absolute inset-0 bg-white/10 backdrop-blur-2xl rounded-[2.5rem] border border-white/20 shadow-2xl transition-all group-hover:bg-white/15"></div>
                                <input
                                    type="text"
                                    name="search"
                                    defaultValue={search}
                                    placeholder="Search our aisles..."
                                    className="relative w-full px-10 py-6 rounded-[2.5rem] bg-transparent text-white placeholder:text-gray-300 outline-none transition-all font-medium text-lg"
                                />
                                <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 bg-primary-500 text-white p-4 rounded-full hover:bg-primary-400 transition-all hover:scale-110 active:scale-95 shadow-xl shadow-primary-500/20">
            ...
            {/* Stats Bar */}
            <div className="bg-primary-950 border-y border-primary-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div className="space-y-1">
                            <div className="text-3xl font-black text-primary-400 italic font-serif">98%</div>
                            <div className="text-[10px] font-bold text-primary-300 uppercase tracking-[0.2em]">Freshness Rate</div>
                        </div>
                        <div className="space-y-1 border-l border-white/10">
                            <div className="text-3xl font-black text-primary-400 italic font-serif">2hr</div>
                            <div className="text-[10px] font-bold text-primary-300 uppercase tracking-[0.2em]">Avg. Delivery</div>
                        </div>
                        <div className="space-y-1 border-l border-white/10">
                            <div className="text-3xl font-black text-primary-400 italic font-serif">500+</div>
                            <div className="text-[10px] font-bold text-primary-300 uppercase tracking-[0.2em]">Local Farms</div>
                        </div>
                        <div className="space-y-1 border-l border-white/10">
                            <div className="text-3xl font-black text-primary-400 italic font-serif">24/7</div>
                            <div className="text-[10px] font-bold text-primary-300 uppercase tracking-[0.2em]">Expert Support</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="flex flex-col lg:grid lg:grid-cols-[280px_1fr] gap-16">
                    ...
                    <aside className="space-y-12 h-fit lg:sticky lg:top-24">
                        <div>
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    {/* {!categoryQuery && <span className="text-sm">✓</span>} */}
                                </button>
                                {categories.map((cat) => (
                                    <button
                                        key={cat.id}
                                    ...
                                    >
                                        <span>{cat.name}</span>
                                        {/* {categoryQuery === cat.name && <span className="text-sm">✓</span>} */}
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-primary-50 p-8 rounded-[2.5rem] border border-primary-100/50">
                    ...
                    <main className="flex-1">
                        {/* Error Handling */}
                        {error && (
                            <div className="mb-12 p-6 bg-red-50 border border-red-100 text-red-600 rounded-3xl font-bold flex items-center">
                        ...
                        {loading ? (
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
                                {[...Array(6)].map((_, i) => (
                                    <div key={i} className="space-y-4 animate-pulse">
                                        <div className="bg-gray-100 h-[350px] rounded-[2.5rem]"></div>
                            ...
                            <div className="text-center py-32 bg-gray-50 rounded-[3rem] border-2 border-dashed border-gray-100">
                                <div className="text-8xl mb-8 grayscale opacity-50 transition-all hover:grayscale-0 hover:opacity-100 cursor-default">🧺</div>
                            ...
                            <div className="space-y-16">
                                ...
                                {pagination.totalPages > 1 && (
                                    <div className="flex justify-between items-center py-12 border-t border-gray-50">
                                        <button
                                        ...
                                        <div className="flex items-center space-x-4">
                                            {[...Array(pagination.totalPages)].map((_, i) => (
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-xl font-bold text-sm transition-all focus:ring-4 focus:ring-primary-500/20 ${page === i + 1 ? 'bg-primary-600 text-white shadow-lg shadow-primary-600/30' : 'text-gray-400 hover:text-gray-900 hover:bg-gray-50'}`}
                                                >
                                                    {i + 1}
                                                </button>
                                            ))}
